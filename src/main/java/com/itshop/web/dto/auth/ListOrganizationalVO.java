...
@Data
public class ListOrganizationalVO  implements Serializable {
     ...
     * 下层组织
     */
    private List<ListOrganizationalVO> subOrganizationals = new ArrayList<>();

    /**
     * 可添加的代理商层级 (小于等于0,不能再添加 代理商)
     */
    private Integer canAddAgentLevel;
