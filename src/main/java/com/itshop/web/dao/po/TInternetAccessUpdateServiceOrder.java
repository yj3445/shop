...
/**
 * t_internet_access_update_service_order
 * @author 
 */
public class TInternetAccessUpdateServiceOrder implements Serializable {
    /**
     * 订单ID
     */
    ...
    public Boolean getIpBackup() {
        return ipBackup;
    }

    public void setIpBackup(Boolean ipBackup) {
        this.ipBackup = ipBackup;
    }

    public Integer getIpExport() {
        return ipExport;
    }

    public void setIpExport(Integer ipExport) {
        this.ipExport = ipExport;
    }
